<div class="container">
    ...
    <div class="page-header">
        <h3> News From <b>detik.com</b></h3>
    </div>

    <div class="row">
        <?php 
            include "./koneksi/koneksi.php";
            $sel = mysql_query("SELECT berita_baru.* , url.sumber AS sumber  FROM berita_baru JOIN url ON berita_baru.id_link = url.id_link WHERE url.sumber = 'detik.com'");
